...
int32_t PWM_PID_0, PWM_PID_1, PWM_PID_2, PWM_PID_3;

static void powerDistributionLegacy(const control_t *control, motors_thrust_uncapped_t* motorThrustUncapped, int32_t *PWM_PID_0, int32_t *PWM_PID_1, int32_t *PWM_PID_2, int32_t *PWM_PID_3)
{
  ...
  *PWM_PID_0 = control->thrust - r + p + control->yaw;
  *PWM_PID_1 = control->thrust - r - p - control->yaw;
  *PWM_PID_2 = control->thrust + r - p + control->yaw;
  *PWM_PID_3 = control->thrust + r + p - control->yaw;
}
...
static void powerDistributionNN(const control_t *control, motors_thrust_uncapped_t* motorThrustUncapped) {
  motorThrustUncapped->motors.m1 = control->motorPwm[0];
...
void powerDistribution(const control_t *control, motors_thrust_uncapped_t* motorThrustUncapped)
{
  switch (control->controlMode) {
    case controlModeLegacy:
      powerDistributionLegacy(control, motorThrustUncapped, &PWM_PID_0, &PWM_PID_1, &PWM_PID_2, &PWM_PID_3);
      break;
    ...
    case controlModeForce:
      ...
      break;
    case controlModeNN:
      powerDistributionNN(control, motorThrustUncapped);
      break;
    default:
      // Nothing here
      break;
...
LOG_ADD(LOG_INT32, motor_pwm_0, &PWM_PID_0)
LOG_ADD(LOG_INT32, motor_pwm_1, &PWM_PID_1)
LOG_ADD(LOG_INT32, motor_pwm_2, &PWM_PID_2)
LOG_ADD(LOG_INT32, motor_pwm_3, &PWM_PID_3)
